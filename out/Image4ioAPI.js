...
var Image4ioClient = /** @class */ (function () {
    ...
    Image4ioClient.prototype.UploadImage = function (model) {
        try {
            return this.UploadImageAsync(model).then(function (response) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.post({ url: this.baseUrl + '/v1.0/uploadImage', formData: formData }, function (err, res, body) {
    ...
    Image4ioClient.prototype.CopyImage = function (model) {
        try {
            return this.CopyImageAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.put(options, function (err, res, body) {
                                if (res.statusCode == 200) {
                                    return body;
                                }
                                else {
    ...
    Image4ioClient.prototype.GetImage = function (model) {
        try {
            return this.GetImageAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.get(options, function (err, res, body) {
                                if (res.statusCode == 200) {
                                    return body;
                                }
                                else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.delete(options, function (err, res, body) {
                                if (res.statusCode == 200) {
                                    return body;
                                }
                                else {
    ...
    Image4ioClient.prototype.DeleteImage = function (model) {
        try {
            return this.DeleteImageAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.post(options, function (err, res, body) {
                                if (res.statusCode == 200) {
                                    return body;
                                }
                                else {
    ...
    Image4ioClient.prototype.FetchImage = function (model) {
        try {
            return this.FetchImageAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
    ...
    Image4ioClient.prototype.FetchStream = function (model) {
        try {
            return this.FetchStreamAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
    ...
    Image4ioClient.prototype.MoveImage = function (model) {
        try {
            return this.MoveImageAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
    ...
    Image4ioClient.prototype.Purge = function () {
        try {
            return this.PurgeAsync().then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
    ...
    Image4ioClient.prototype.GetSubscription = function () {
        try {
            return this.GetSubscriptionAsync().then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
    ...
    Image4ioClient.prototype.StartUploadStream = function (model) {
        try {
            return this.StartUploadStreamAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
    ...
    Image4ioClient.prototype.UploadStreamPart = function (model) {
        try {
            return this.UploadStreamPartAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.patch({ url: this.baseUrl + '/v1.0/uploadStream', formData: formData }, function (err, res, body) {
                                if (res.statusCode == 200) {
                                    return body;
                                }
                                else {
    ...
    Image4ioClient.prototype.FinalizeStream = function (model) {
        try {
            return this.FinalizeStreamAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
    ...
    Image4ioClient.prototype.GetStream = function (model) {
        try {
            return this.GetStreamAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
    ...
    Image4ioClient.prototype.DeleteStream = function (model) {
        try {
            return this.DeleteStreamAsync(model).then(function (response) {
                return JSON.parse(String(response));
            }).catch(function (exception) {
                throw exception;
            });
